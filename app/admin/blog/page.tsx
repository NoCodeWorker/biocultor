    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-card border border-border/60 rounded-2xl p-5">
          <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Total artículos</p>
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-5 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-start gap-3 text-sm">
          ...
          <div>
            <p className="font-bold text-foreground">Landings y servicios se gestionan fuera de Blog</p>
            <p className="text-muted-foreground mt-0.5">
              Esta pantalla queda reservada para artículos. Usa Landings & SEO o Servicios para páginas con payload visual.
            </p>
          </div>
        </div>
        <Link 

# Roadmap Estratégico SEO / GEO / IA - Biocultor
**Objetivo:** Dominar las búsquedas transaccionales (intención de compra) e informacionales de alta cualificación para "Té de Humus de Lombriz" a través de todas las audiencias objetivo.
**Enfoque:** 
- **SEO:** Palabras clave de cola larga transaccionales.
- **GEO:** Adaptación a climas y regiones específicas (España, Mediterráneo, Secano).
- **IA (AIO):** Estructuras claras, datos técnicos, tablas de dosificación (favoritos de Perplexity y ChatGPT).

> **Política Editorial y Científica (Skill Obligatoria):** Todos los artículos y landing pages implementados en este Roadmap DEBEN cumplir estrictamente con la [ADR-002: Editorial Evidence Policy](file:///d:/BIOCULTOR/BIOCULTOR%20SHOP/biocultor/docs/decisions/ADR-002-editorial-evidence-policy.md). Cero "fluff", cero afirmaciones sin base agronómica.

---

## 1. Paisajistas y Empresas de Mantenimiento Verde (B2B)
*Audiencia que busca eficiencia, reducción de costes, escalabilidad y resultados visibles rápidos.*
- [x] Cómo Recuperar el Césped Amarillo: Por qué el Té de Humus Líquido Supera al Abono Químico
- [x] Té de Humus Líquido en Mantenimiento de Zonas Verdes: Reducción de Costes y Tiempos
...
## 3. Agricultura Profesional (Olivar, Viñedo, Frutales, Extensivo)
*Audiencia que busca ROI, mitigación de estrés hídrico y cumplimiento de normativas ecológicas.*
...
## 7. Amantes de la Jardinería y Cuidado Floral (Aficionados y Semilleros)
*Audiencia apasionada por la floración ornamental, rosales, bulbos y semilleros de primavera.*
- [ ] Post: Té de Humus Líquido para Estimular la Floración en Rosales y Arbustos Ornamentales
- [ ] Post: Prevención del "Damping-off" (Caída de plántulas) en Semilleros Usando Humus Líquido
- [ ] Post: Revitalización de Suelos de Macizo Floral sin Cavar (Técnica "No-Till" con Extracto Líquido)

## 8. Viveros, Floristas y Producción Ornamental (B2B Retail y Propagación)
*Audiencia profesional que busca enraizamiento rápido, sanidad vegetal en invernadero y reducción de mermas.*
- [ ] Post: Aceleración del Enraizamiento en Esquejes de Planta Ornamental con Té de Humus
- [ ] Post: Control Biológico Preventivo en Invernaderos de Alta Humedad mediante Aplicación Foliar
- [ ] Post/Landing: Té de Humus Líquido para Viveros: Cómo Reducir la Dependencia de Fungicidas Químicos

## 9. Propietarios de Viviendas Unifamiliares con Terreno (Césped y Árboles)
*Audiencia residencial con parcelas, que quiere un jardín verde y seguro para su familia sin ser un experto agrónomo.*
- [ ] Post: Abono Seguro para Césped en Chalets: Sin Tóxicos, Sin Quemaduras y Seguro para Mascotas
- [ ] Post: Cómo Abonar Árboles Frutales en tu Parcela sin Cavar Zanjas (Aplicación por Goteo o Regadera)
- [ ] Post: Mantenimiento Sostenible del Jardín de tu Chalet: Un Solo Abono Líquido para Todo el Terreno
...
- [x] Post: Cómo leer un estudio sobre extractos de ortiga y defensa de la planta (`extracto-ortiga-defensa-planta-estudio`)
- [x] Post: Purín de ortiga para plantas: qué observa la investigación y qué no puede prometerse (`purin-de-ortiga-para-plantas-evidencia`)
- [x] Post: Purín de ortiga casero frente a concentrado: qué dice la investigación y cuándo comprar (`purin-de-ortiga-casero-vs-concentrado-compra`)
- [x] Post: Purín de ortiga para tomates y hortalizas: contexto de uso con base en evidencia (`purin-de-ortiga-para-tomates-y-hortalizas`)
- [x] Post: Purín de ortiga: dosis, frecuencia y dilución correcta según el cultivo (`purin-ortiga-dosis-frecuencia-aplicacion`)
